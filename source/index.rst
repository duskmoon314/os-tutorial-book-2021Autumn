.. sphinx-rtd-template documentation master file, created by
   sphinx-quickstart on Fri Aug 20 23:02:53 2021.
...
本教程展示了如何 **从零开始** 用 **Rust/C** 语言写一个基于 **RISC-V** 架构的 **类 Unix 内核** 。
...
鸣谢
----------------------
本项目基于 `2021 年春季学期操作系统实验指导书 <https://rcore-os.github.io/rCore-Tutorial-Book-v3/index.html>` ，重构的目标是在保留结构的基础上屏蔽不必要的细节，缩短篇幅，优化语言，降低阅读成本。
